...
由 **[Dexorynlabs](https://t.me/dexoryn777)** 开发 · **Dexoryn** — 对本 Demo、模拟器或产品集成有疑问？[Telegram](https://t.me/dexoryn777) · [X @dexoryn](https://x.com/dexoryn)
...
- 每页顶栏**开发者联系卡片**（Dexoryn · Telegram · X）
...
│   ├── social.ts           Telegram 与 X 链接（顶栏 + 页脚）
│   └── confetti.ts         共享庆祝效果
